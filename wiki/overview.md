...
See [[index]] for the full map (the [[Index and Log]] navigation pattern). Domains hold *your* curated notes; `sources/`, `concepts/`, and `entities/` are the knowledge layer the ingestion pipeline builds automatically.
