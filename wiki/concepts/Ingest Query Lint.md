...
Run lint every ~10–15 ingests. Operations are recorded in [[Index and Log]]. See [[Karpathy - LLM Wiki]] by [[Andrej Karpathy]]. The vault-specific implementation of the ingest contract (steps 1–5, manifest check, page-writing rules) lives in [[meta/conventions]].
